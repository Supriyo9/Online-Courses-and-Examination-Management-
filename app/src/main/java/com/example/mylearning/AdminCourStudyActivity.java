...
public class AdminCourStudyActivity extends AppCompatActivity {
    ...
    private AdminStudyCourseActivityAdapter AssignAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_cour_study);



        Toolbar toolbar=findViewById(R.id.AStudytoolbarCateg);
       ...
       /* loadingDialog=new Dialog(AdminCourStudyActivity.this);
        ...
        */
        ...
        addCatDialog=new Dialog(AdminCourStudyActivity.this);
        ...
        //////
        FirstTimeAdd=new Dialog(AdminCourStudyActivity.this);
        ...
        FistTime.setText("Enter Topic Name Below");
        ...
        AssignAdapter=new AdminStudyCourseActivityAdapter(AdminCourStudyActivity.this,result);
    ...
    private void uploadPDFfile(Uri data) {
        ...
        StorageReference reference=storageReference.child("StudyMaterial/"+System.currentTimeMillis()+".pdf");
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        myRef =database.getReference("StudyMaterial");
                        ...
                        Toast.makeText(AdminCourStudyActivity.this,"File Uploaded",Toast.LENGTH_SHORT).show();
    ...
    public void getResults() {
        ...
        myRef.child("StudyMaterial").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    class AdminStudyCourseActivityAdapter extends ArrayAdapter<String> {

        private Context mContext;
        ArrayList<String> dataList;

        public AdminStudyCourseActivityAdapter( Context context,ArrayList<String> list) {
        ...
        public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            ((Button)listItem.findViewById(R.id.item_button)).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent=new Intent(AdminCourStudyActivity.this, AdminStudyActivity.class);
