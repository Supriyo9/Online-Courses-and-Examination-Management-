...
public class AdminAssignCourseActivity extends AppCompatActivity {
    ...
    private AdminAssignCourseActivityAdapter AssignAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar=findViewById(R.id.AAAtoolbarCateg);
       ...
       /* loadingDialog=new Dialog(AdminAssignCourseActivity.this);
        ...
        */
        ...
        addCatDialog=new Dialog(AdminAssignCourseActivity.this);
        ...
        //////
        FirstTimeAdd=new Dialog(AdminAssignCourseActivity.this);
        ...
        FistTime.setText("Enter Assignment Name Below");
        ...
        AssignAdapter=new AdminAssignCourseActivityAdapter(AdminAssignCourseActivity.this,result);
            ...
            reference.putFile(data)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            myRef =database.getReference("Assignment");
                            ...
                            Toast.makeText(AdminAssignCourseActivity.this,"File Uploaded",Toast.LENGTH_SHORT).show();
    ...
    public void getResults() {
        ...
        myRef.child("Assignment").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    class AdminAssignCourseActivityAdapter extends ArrayAdapter<String> {

        private Context mContext;
        ArrayList<String> dataList;

        public AdminAssignCourseActivityAdapter( Context context,ArrayList<String> list) {
        ...
        public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            ((Button)listItem.findViewById(R.id.item_button)).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent=new Intent(AdminAssignCourseActivity.this, AdminAssignmentActivity.class);
            ...
            ((Button)listItem.findViewById(R.id.item_sol)).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent=new Intent(AdminAssignCourseActivity.this, ViewAssignmentSolActivity.class);
                    intent.putExtra("test",dataList.get(position));
                    //////intent.putExtra("ISAdmin",isAdmin);
                    startActivity(intent);
                }
