...
public class AdminEvntCourseActivity extends AppCompatActivity {
    ...
    private AdminEventCourseActivityAdapter AssignAdapter;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_admin_evnt_course);



        Toolbar toolbar=findViewById(R.id.ACourtoolbarPro);
       ...
       /* loadingDialog=new Dialog(AdminEvntCourseActivity.this);
        ...
        */
        ...
        addCatDialog=new Dialog(AdminEvntCourseActivity.this);
        ...
        //////
        FirstTimeAdd=new Dialog(AdminEvntCourseActivity.this);
        ...
        FistTime.setText("Enter Event Name Below");
        ...
        AssignAdapter=new AdminEventCourseActivityAdapter(AdminEvntCourseActivity.this,result);
        ...
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(AdminEvntCourseActivity.this,"File Uploaded",Toast.LENGTH_SHORT).show();
    ...
    public void getResults() {
        ...
        myRef.child("Event").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    class AdminEventCourseActivityAdapter extends ArrayAdapter<String> {

        private Context mContext;
        ArrayList<String> dataList;

        public AdminEventCourseActivityAdapter( Context context,ArrayList<String> list) {
        ...
        public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            ((Button)listItem.findViewById(R.id.item_button)).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent=new Intent(AdminEvntCourseActivity.this, AdminEventActivity.class);
