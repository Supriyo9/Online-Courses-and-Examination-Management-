...
public class StudntAssignCourseActivity extends AppCompatActivity {
    ...
    private StudentAssignCourseActivityAdapter AssignAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_studnt_assign_course);




        Toolbar toolbar=findViewById(R.id.StudentAsssitoolbar);
...
/*
        loadingDialog=new Dialog(StudntAssignCourseActivity.this);
 ...
 */
        ...
        AssignAdapter=new StudentAssignCourseActivityAdapter(StudntAssignCourseActivity.this,result);
    ...
    class StudentAssignCourseActivityAdapter extends ArrayAdapter<String> {

        private Context mContext;
        ArrayList<String> dataList;

        public StudentAssignCourseActivityAdapter( Context context,ArrayList<String> list) {
        ...
        public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ...
            ((Button)listItem.findViewById(R.id.item_button)).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent=new Intent(StudntAssignCourseActivity.this, Assignment.class);
