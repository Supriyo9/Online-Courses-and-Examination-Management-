...
public class AttemptTest extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        candidatename=MainActivity.FullName;
...
//                setAlertDialog(answerText);
    ...
    void submit(){
        ...
        try {
            ...
            ScoreHelper informationm= new ScoreHelper(candidatename, score);



            mDatabase.child("Results").child(((Test) getIntent().getExtras().get("Questions")).getName())
                    .child(auth.getUid()) .setValue(informationm);
        }catch (Exception e){
...
//                        dialog.dismiss();
    ...
    protected void onResume() {
        ...
        if(countPaused>1) {
            Toast.makeText(AttemptTest.this, "Thank you! Your response has been submitted.",
